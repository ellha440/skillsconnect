...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { about: @employer.about, address: @employer.address, company_name: @employer.company_name }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { about: @employer.about, address: @employer.address, company_name: @employer.company_name }
    assert_redirected_to employer_path(assigns(:employer))
  end
